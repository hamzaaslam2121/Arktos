...
// .wrangler/tmp/bundle-Yccnj2/checked-fetch.js
...
// .wrangler/tmp/bundle-Yccnj2/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-Yccnj2/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
  ...
  try {
    ...
    return new Response(JSON.stringify({ error: "Failed to create checkout session", details: errorMessage }), {
      ...
      headers: {
        ...headers,
        "Access-Control-Allow-Origin": "*"
        // Add this to error response as well
      }
    });
  }
}
